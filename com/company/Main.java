...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while(!(principal>=1000&&principal<=1000000)){
            System.out.println("Principal should be in between 1000 and 1000000");
            System.out.print("Enter Principal: ");
            principal = scanner.nextDouble();
        }
        ...
        while(!(rate>0 && rate<=30)){
            System.out.println("Rate should be in between 0 and 30");
            System.out.print("Enter Rate: ");
            rate=scanner.nextFloat();
        }
        ...
        while(!(period>0&&period<=30)){
            System.out.println("Period should be in between 0 and 30");
            System.out.print("Enter Period: ");
            period = scanner.nextInt();
        }
        period*=12;
        ...
        mortgage = principal * monthlyRate * val /(val-1);
...
// Purely object Based
// C and python are both object based as well as procedural based
// Java is both compiled and interpreted language
// for classes we use pascal convention and for functions we use camel case conventions.
// camelCaseConvention ---->  PascalConvention
// Println adds a new line at the end of the the statement
// Java supports a $ symbol for the variable
